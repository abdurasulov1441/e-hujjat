...
class OrinbosarlarPage extends StatefulWidget {
  const OrinbosarlarPage({super.key});

  @override
  State<OrinbosarlarPage> createState() => _OrinbosarlarPageState();
}

class _OrinbosarlarPageState extends State<OrinbosarlarPage> {
